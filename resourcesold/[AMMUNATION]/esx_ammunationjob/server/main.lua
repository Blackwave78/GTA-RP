		...
		local xPlayer  = ESX.GetPlayerFromId(source)
			...
			if poudreQuantity < 5 or douilleQuantity < 5 then
				...
				SetTimeout(800, function() --1800
					...
					xPlayer.addInventoryItem('clips', 1)
...
local function VenteMunition(source)
  ...
  SetTimeout(800, function() --1800
    ...
    local Quantity = xPlayer.getInventoryItem('clips').count
    ...
    if Quantity < 1 then
      ...
      xPlayer.removeInventoryItem('clips', 1)
		local societyAccount = nil
...
local function CraftPistolet(source)
  ...
  SetTimeout(800, function() --15000
    ...
    if PlayersCrafting[source] == true then
	  ...
	  local ClipQuantity = xPlayer.getInventoryItem('clips').count
	  local clip = false
