...
Config.Zones = {
	...
	Minefarm = {
		...
		Pos   = {x = 2930.9636230469, y = 2790.4069824219, z = 39.165353037109},
	...
	TraitementMine = {
		Pos   = {x = 984.09436035156, y = -1924.0220947266, z = 30.134477615356},
		Size  = {x = 3.5, y = 3.5, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
...
--	},
	...
	SellFarm = {
		Pos   = {x = -621.85034179688, y = -230.99514770508, z = 37.067052612305},
		Size  = {x = 3.5, y = 3.5, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
	...
	VehicleDeleter = {
		Pos   = {x = 824.05792236328, y = -1917.3870849609, z = 28.314956665039},
