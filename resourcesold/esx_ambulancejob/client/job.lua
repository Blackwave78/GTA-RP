...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		align    = 'top-left',
		elements = {
			{label = _U('pharmacy_take', _U('gauze')), item = 'gauze', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('bandage')), item = 'bandage', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('firstaid')), item = 'firstaid', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('medkit')), item = 'medkit', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('vicodin')), item = 'vicodin', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('hydrocodone')), item = 'hydrocodone', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('morphine')), item = 'morphine', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', _U('adrenaline')), item = 'adrenaline', type = 'slider', value = 1, min = 1, max = 50},
	}}, function(data, menu)
