...
Config.TimeToSell = 3 -- how many seconds player have to wait/stand near ped
...
Config.PedRejectPercent = 5 -- (min1) if 1 ped reject offer=100%, 2=50%, 3=33%, 4=25%, 5=20%
...
Config.WeedPrice = 31	-- sell price for single, not pooch (black money)
Config.MethPrice = 45	-- sell price for single, not pooch (black money)
Config.CokePrice = 30	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 47	-- sell price for single, not pooch (black money)
