      ...
      if playersNativeHarvest[source] == true then
        ...
        local quantity = bag.count
          ...
          if quantity >= bag.limit then
            ...
            TriggerClientEvent('esx_garbadge:nextMarket', source)
          end
...
RegisterServerEvent('esx_garbadge:startHarvestRun')
AddEventHandler('esx_garbadge:startHarvestRun', function()
...
RegisterServerEvent('esx_garbadge:stopHarvestRun')
AddEventHandler('esx_garbadge:stopHarvestRun', function()
    ...
    if playersNativeSell[source] == true then
      ...
      if quantity < Config.itemRemove then
        ...
        local gouvTaxe = math.floor(companyPrice * Config.gouvRate)
         TriggerEvent('esx_addonaccount:getSharedAccount', 'society_Litlle_Pricks', function(account)account.addMoney(companyPrice)end )
         TriggerEvent('esx_addonaccount:getSharedAccount', 'society_taxe_Litlle_Pricks', function(account)account.addMoney(gouvTaxe)end )
...
RegisterServerEvent('esx_garbadge:startSellRun')
AddEventHandler('esx_garbadge:startSellRun', function()
...
RegisterServerEvent('esx_garbadge:stopSellRun')
AddEventHandler('esx_garbadge:stopSellRun', function()
...
RegisterServerEvent('esx_garbadge:startWeeklyCollect')
AddEventHandler('esx_garbadge:startWeeklyCollect', function()
...
RegisterServerEvent('esx_garbadge:stopWeeklyCollect')
AddEventHandler('esx_garbadge:stopWeeklyCollect', function()
...
function weeklyDestruct(source)
  ...
  SetTimeout(Config.blackTime, function()
    ...
    if playersBlackDestructExit[source] then
    ...
    if playersBlackDestruct[source] == true then
        ...
        local amountRBis = Config.blackRemove % 1000
          ...
          if amountRBis < 100 then
           amountR = amountR .. '0'
          end
         
          if amountRBis < 10  then
           amountR = amountR .. '0'
          end
          ...
          amountR = amountR .. amountRBis
            ...
            if account.money < Config.blackRemove then
              ...
              local amountPBis = Config.blackPrice % 1000
                if amountPBis < 100 then
                  amountP = amountP .. '0'
                end
                
                if amountPBis < 10  then
                 amountP = amountP .. '0'
                end
      ...
      TriggerClientEvent('esx:showNotification', source, _U('weekly_destruct_fail')) 
    end
  end)
end


RegisterServerEvent('esx_garbadge:startWeeklyDestruct')
AddEventHandler('esx_garbadge:startWeeklyDestruct', function()
...
RegisterServerEvent('esx_garbadge:stopWeeklyDestruct')
AddEventHandler('esx_garbadge:stopWeeklyDestruct', function()
...
-- get Storage
ESX.RegisterServerCallback('esx_garbadge:getStockItems', function(source, cb)
  printDebug('getStockItems')
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_Litlle_Pricks', function(inventory)
    cb(inventory.items)
  end)
end)


RegisterServerEvent('esx_garbadge:getStockItem')
AddEventHandler('esx_garbadge:getStockItem', function(itemName, count)
...
-- put Storage 
ESX.RegisterServerCallback('esx_garbadge:getPlayerInventory', function(source, cb)
...
RegisterServerEvent('esx_garbadge:putStockItems')
AddEventHandler('esx_garbadge:putStockItems', function(itemName, count)
...
-- get weapon
ESX.RegisterServerCallback('esx_garbadge:getArmoryWeapons', function(source, cb)
  printDebug('getArmoryWeapons')
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_Litlle_Pricks', function(store)
...
-- put weapon
ESX.RegisterServerCallback('esx_garbadge:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
...
ESX.RegisterServerCallback('esx_garbadge:removeArmoryWeapon', function(source, cb, weaponName)
