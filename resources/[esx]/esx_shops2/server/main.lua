...
MySQL.ready(function()
	...
	local shopResult = MySQL.Sync.fetchAll('SELECT * FROM shops3')
...
AddEventHandler('esx_shops2:buyItem', function(itemName, amount, zone)
	...
	if amount < 0 then
		print('esx_shops2: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
