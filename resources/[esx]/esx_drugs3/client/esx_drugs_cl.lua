...
AddEventHandler('esx_drugs3:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_drugs3:hasExitedMarker', function(zone)
	CurrentAction = nil
	ESX.UI.Menu.CloseAll()

	TriggerServerEvent('esx_drugs3:stopHarvestCoke')
	TriggerServerEvent('esx_drugs3:stopTransformCoke')
	TriggerServerEvent('esx_drugs3:stopSellCoke')
	TriggerServerEvent('esx_drugs3:stopHarvestMeth')
	TriggerServerEvent('esx_drugs3:stopTransformMeth')
	TriggerServerEvent('esx_drugs3:stopSellMeth')
	TriggerServerEvent('esx_drugs3:stopHarvestWeed')
	TriggerServerEvent('esx_drugs3:stopTransformWeed')
	TriggerServerEvent('esx_drugs3:stopSellWeed')
	TriggerServerEvent('esx_drugs3:stopHarvestOpium')
	TriggerServerEvent('esx_drugs3:stopTransformOpium')
	TriggerServerEvent('esx_drugs3:stopSellOpium')
end)

-- Weed Effect
RegisterNetEvent('esx_drugs3:onPot')
AddEventHandler('esx_drugs3:onPot', function()
...
RegisterNetEvent('esx_drugs3:ReturnInventory')
AddEventHandler('esx_drugs3:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	   = cokeNbr
	...
	myJob		 = jobName
	TriggerEvent('esx_drugs3:hasEnteredMarker', currentZone)
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerServerEvent('esx_drugs3:GetUserInventory', currentZone)
		end

		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('esx_drugs3:hasExitedMarker', lastZone)
		end

		if isInMarker and isInZone then
			TriggerEvent('esx_drugs3:hasEnteredMarker', 'exitMarker')
		end
	end
end)
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				if CurrentAction == 'exitMarker' then
					...
					TriggerEvent('esx_drugs3:freezePlayer', false)
					TriggerEvent('esx_drugs3:hasExitedMarker', lastZone)
					Citizen.Wait(15000)
				elseif CurrentAction == 'CokeField' then
					TriggerServerEvent('esx_drugs3:startHarvestCoke')
				elseif CurrentAction == 'CokeProcessing' then
					TriggerServerEvent('esx_drugs3:startTransformCoke')
				elseif CurrentAction == 'CokeDealer' then
					TriggerServerEvent('esx_drugs3:startSellCoke')
				elseif CurrentAction == 'MethField' then
					TriggerServerEvent('esx_drugs3:startHarvestMeth')
				elseif CurrentAction == 'MethProcessing' then
					TriggerServerEvent('esx_drugs3:startTransformMeth')
				elseif CurrentAction == 'MethDealer' then
					TriggerServerEvent('esx_drugs3:startSellMeth')
				elseif CurrentAction == 'WeedField' then
					TriggerServerEvent('esx_drugs3:startHarvestWeed')
				elseif CurrentAction == 'WeedProcessing' then
					TriggerServerEvent('esx_drugs3:startTransformWeed')
				elseif CurrentAction == 'WeedDealer' then
					TriggerServerEvent('esx_drugs3:startSellWeed')
				elseif CurrentAction == 'OpiumField' then
					TriggerServerEvent('esx_drugs3:startHarvestOpium')
				elseif CurrentAction == 'OpiumProcessing' then
					TriggerServerEvent('esx_drugs3:startTransformOpium')
				elseif CurrentAction == 'OpiumDealer' then
					TriggerServerEvent('esx_drugs3:startSellOpium')
				else
					isInZone = false -- not a esx_drugs3 zone
				end
				
				if isInZone then
				--	TriggerEvent('esx_drugs3:freezePlayer', true)
				end
...
RegisterNetEvent('esx_drugs3:freezePlayer')
AddEventHandler('esx_drugs3:freezePlayer', function(freeze)
