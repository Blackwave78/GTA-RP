...
Locales['fr'] = {
	...
	['feuilletab_taken'] = 'Vous être en train de ramasser du tabac',
	['press_traitement'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer votre tabaac',
	...
	['no_tabacsec_sale'] = 'Vous n\'avez plus ou pas assez de jus de tabac',
	['no_vin_sale'] = 'Vous n\'avez plus ou pas assez de tabac',
	['not_enough_feuilletab'] = 'Vous n\'avez plus de tabac',
	...
	['used_jus'] = 'Vous avez bu du jus de tabac',
	['used_tabacsec'] = 'none',
