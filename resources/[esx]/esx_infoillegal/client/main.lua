...
function OpenInfoIllegalMenu()
  ...
  local elements = { }
	  ...
	  table.insert(elements, {label = _U('washm') .. Config.PriceWashBM .. _U('washm1'),    value = 'washm'})
	  table.insert(elements, {label = _U('Blackm') .. Config.BlackweashopPR .. _U('Blackm1'),    value = 'Blackm'})
	  table.insert(elements, {label = _U('CarS') .. Config.BlackweashopPR .. _U('CarM'),    value = 'carResel'})
  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'info',
      {
		...
		if data.current.value == 'washm' then
           TriggerServerEvent("esx_infoillegal:WMoney")
		   ESX.UI.Menu.CloseAll()
        end
		if data.current.value == 'Blackm' then
           TriggerServerEvent("esx_infoillegal:Bmarker")
		   ESX.UI.Menu.CloseAll()
        end
       	if data.current.value == 'carResel' then
           TriggerServerEvent("esx_infoillegal:BCmarker")
		   ESX.UI.Menu.CloseAll()
        end
...
AddEventHandler("esx_infoillegal:WashMoney", function()
	if Config.GPS then
		...
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('WashMoney'))
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('WashMoney1'))
	end
end)

RegisterNetEvent("esx_infoillegal:Blackweashop")
AddEventHandler("esx_infoillegal:Blackweashop", function()
	if Config.GPS then
		x, y, z = Config.Blackweashop.x, Config.Blackweashop.y, Config.Blackweashop.z
		SetNewWaypoint(x, y, z)
		local source = GetPlayerServerId();
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	else
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Blackweashop'))
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Blackweashop1'))
	end
end)

RegisterNetEvent("esx_infoillegal:BlackCars")
AddEventHandler("esx_infoillegal:BlackCars", function()
	if Config.GPS then
		x, y, z = Config.BlackCars.x, Config.BlackCars.y, Config.BlackCars.z
		SetNewWaypoint(x, y, z)
		local source = GetPlayerServerId();
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	else
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Blackcarsell'))
		TriggerEvent("esx_infoillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Blackcarsell1'))
	end
end)
