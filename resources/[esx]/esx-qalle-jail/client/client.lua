	...
	while true do
		...
		if jailTime > 0 then
			...
			local DistanceCheck = GetDistanceBetweenCoords(PedPosition, JailLocation["x"], JailLocation["y"], JailLocation["z"], true)
				if GetDistanceBetweenCoords(GetEntityCoords(playerPed), JailLocation.x, JailLocation.y, JailLocation.z) > 250 then
...
function SendDistressSignal()
    ...
    TriggerServerEvent('esx_addons_gcphone:startCall', 'police', 'Tentative d\'evasion', JailLocation, {
