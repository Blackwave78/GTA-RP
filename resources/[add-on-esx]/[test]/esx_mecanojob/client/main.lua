			...
			if GotTrailer then
				...
				ESX.TriggerServerCallback('eden_garage:stockvmecano',function(valid)
					if(valid) then
						...
						TriggerServerEvent('eden_garage2:ChangeStateFromFourriereMecano', trailerProps, true)
				...
				ESX.TriggerServerCallback('eden_garage:stockvmecano',function(valid)
					if(valid) then
						...
						TriggerServerEvent('eden_garage2:ChangeStateFromFourriereMecano', vehicleProps, true)
