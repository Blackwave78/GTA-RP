...
Config.CheckPoints = {

  {
    ...
    Action = function(playerPed, vehicle, setCurrentZoneType)
      DrawMissionText(_U('next_point_speed') .. Config.SpeedLimits['residence'] .. 'mp/h', 5000)
    end
  },
...

  {
    ...
    Action = function(playerPed, vehicle, setCurrentZoneType)
      ...
      Citizen.CreateThread(function()
        DrawMissionText(_U('stop_look_left') .. Config.SpeedLimits['town'] .. 'mp/h', 5000)
        PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', 0, 0, 1)
        FreezeEntityPosition(vehicle, true)
        Citizen.Wait(6000)
        FreezeEntityPosition(vehicle, false)
...

  {
    ...
    Action = function(playerPed, vehicle, setCurrentZoneType)
      ...
      DrawMissionText(_U('hway_time') .. Config.SpeedLimits['freeway'] .. 'mp/h', 5000)
      PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', 0, 0, 1)
    end
  },
...

  {
    ...
    Action = function(playerPed, vehicle, setCurrentZoneType)
      ...
      DrawMissionText(_U('in_town_speed') .. Config.SpeedLimits['town'] .. 'mp/h', 5000)
    end
  },
