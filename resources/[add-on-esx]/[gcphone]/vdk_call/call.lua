...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(1, 157) and callActive then
        ...
        elseif IsControlJustPressed(1, 158) and callActive then
...
AddEventHandler("call:callIncoming", function(job, pos, msg)
    ...
    work = job
    target.pos = pos
	SendNotification("Appuyez sur ~b~1~s~ pour prendre l'appel ou ~r~2~s~ pour le refuser")
	if work == "police" then
